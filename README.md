...
An interactive Tableau dashboard sits on top of the model's outputs, presenting the investment thesis at a
glance.

## Dashboard

Built in Tableau Public and viewable in the browser without installing anything. The design is deliberately
minimal — the headline valuation metrics and the production trajectory that drives the whole thesis, with no
visual clutter.

▶ **[Open the Tableau dashboard](https://public.tableau.com/app/profile/andreas.santucci/viz/VISTAENERGYDASHBOARD-BYSANTUCCIANDREAS/Dashboard1)**

The dashboard leads with four headline metrics — blended price target, 2030E production, upside to the current
share price, and 2030E adjusted EBITDA — above a single production ramp-up curve. Actual years (2022–2025) are
drawn in grey and projected years (2026E–2030E) in colour, so the ~4x production growth driven by Vaca Muerta
...
- **Growth does not erode profitability.** Production rises ~4x from 2022A to 2030E while the adjusted EBITDA
  margin holds near 65% and lifting cost falls from US$4.3 to US$3.5 per barrel.
